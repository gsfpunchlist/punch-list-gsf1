...
function getReport(data) {
  ...
  var html =
    ...
    '<h1 style="color:#fff;margin:0;font-size:20px">Reporte Semanal — Punch List GSF1 CCPP</h1>' +
    '<p style="color:#9FE1CB;margin:6px 0 0;font-size:13px">' + fecha + '</p>' +
    '</div>' +
    '<div style="background:#f9f9f9;padding:20px;border:1px solid #ddd">' +
    '<table style="width:100%;border-collapse:collapse;margin-bottom:20px"><tr>' +
    '<td style="background:#fff;border:1px solid #eee;padding:16px;text-align:center;border-radius:6px">' +
    '<div style="font-size:32px;font-weight:bold;color:#1a1a1a">' + total + '</div>' +
    '<div style="font-size:12px;color:#888;margin-top:4px">TOTAL</div></td>' +
    '<td style="width:12px"></td>' +
    '<td style="background:#FCEBEB;border:1px solid #f5c6c6;padding:16px;text-align:center;border-radius:6px">' +
    '<div style="font-size:32px;font-weight:bold;color:#791F1F">' + abiertos.length + '</div>' +
    '<div style="font-size:12px;color:#A32D2D;margin-top:4px">ABIERTOS</div></td>' +
    '<td style="width:12px"></td>' +
    '<td style="background:#EAF3DE;border:1px solid #c3e6a3;padding:16px;text-align:center;border-radius:6px">' +
    '<div style="font-size:32px;font-weight:bold;color:#27500A">' + cerrados.length + '</div>' +
    '<div style="font-size:12px;color:#3B6D11;margin-top:4px">CERRADOS</div></td>' +
    '</tr></table>' +
    '<h3 style="color:#0F6E56;border-bottom:2px solid #0F6E56;padding-bottom:6px;margin-top:20px">Por Área / Disciplina</h3>' +
    '<table style="width:100%;border-collapse:collapse;font-size:13px">' +
    '<tr style="background:#0F6E56;color:#fff">' +
    '<th style="padding:8px;text-align:left">Área</th>' +
    '<th style="padding:8px;text-align:center">Abiertos</th>' +
    '<th style="padding:8px;text-align:center">Cerrados</th>' +
    '<th style="padding:8px;text-align:center">Total</th>' +
    '<th style="padding:8px;text-align:center">% Cierre</th></tr>' +
    areaRows + '</table>' +
    '<h3 style="color:#0F6E56;border-bottom:2px solid #0F6E56;padding-bottom:6px;margin-top:24px">Ítems Abiertos</h3>' +
    '<table style="width:100%;border-collapse:collapse;font-size:12px">' +
    '<tr style="background:#0F6E56;color:#fff">' +
    '<th style="padding:6px">ID</th><th style="padding:6px">Fecha</th>' +
    '<th style="padding:6px">Área</th><th style="padding:6px">KKS</th>' +
    '<th style="padding:6px;text-align:left">Descripción</th><th style="padding:6px">Inspector</th></tr>' +
    itemRows + '</table></div>' +
    '<div style="background:#f0f0f0;padding:12px 20px;text-align:center;font-size:11px;color:#888;border-radius:0 0 8px 8px">' +
    'Punch List GSF1 CCPP - TSK &nbsp;·&nbsp; Generado automáticamente por Make.com &nbsp;·&nbsp;' +
    '<a href="https://docs.google.com/spreadsheets/d/' + CONFIG.SHEET_ID + '" style="color:#0F6E56">Ver Sheet completo</a>' +
    '</div></div>';
