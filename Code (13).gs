...
function getReport(data) {
  ...
  var html =
    ...
    // ─ HEADER ─
    '<tr><td style="background-color:#0F6E56;border-radius:8px 8px 0 0;padding:28px 32px">' +
    '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>' +
    '<td>' +
    '<div style="font-size:11px;color:#9FE1CB;font-weight:bold;letter-spacing:2px;text-transform:uppercase;margin-bottom:6px">REPORTE SEMANAL AUTOMATICO</div>' +
    '<div style="font-size:22px;font-weight:bold;color:#ffffff;margin-bottom:4px">Punch List GSF1 CCPP</div>' +
    '<div style="font-size:13px;color:#9FE1CB">TSK &nbsp;&bull;&nbsp; ' + fecha + '</div>' +
    '</td>' +
    '<td align="right" width="100">' +
    '<div style="background-color:#085041;border-radius:8px;padding:12px 16px;text-align:center">' +
    '<div style="font-size:28px;font-weight:bold;color:#ffffff">' + pct_global + '%</div>' +
    '<div style="font-size:10px;color:#9FE1CB;margin-top:2px">CIERRE</div>' +
    '</div>' +
    '</td>' +
    '</tr></table>' +
    '</td></tr>' +
    ...
    '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>' +
    '<td width="31%" style="background-color:#f8f8f8;border:1px solid #e0e0e0;border-radius:6px;padding:16px;text-align:center">' +
    '<div style="font-size:34px;font-weight:bold;color:#1a1a1a">' + total + '</div>' +
    '<div style="font-size:10px;color:#888888;font-weight:bold;letter-spacing:1px;margin-top:4px">TOTAL</div>' +
    '</td>' +
    '<td width="4%"></td>' +
    '<td width="31%" style="background-color:#FFF0F0;border:1px solid #FFCCCC;border-radius:6px;padding:16px;text-align:center">' +
    '<div style="font-size:34px;font-weight:bold;color:#CC0000">' + abiertos.length + '</div>' +
    '<div style="font-size:10px;color:#CC0000;font-weight:bold;letter-spacing:1px;margin-top:4px">ABIERTOS</div>' +
    '</td>' +
    '<td width="4%"></td>' +
    '<td width="31%" style="background-color:#F0FFF0;border:1px solid #AADDAA;border-radius:6px;padding:16px;text-align:center">' +
    '<div style="font-size:34px;font-weight:bold;color:#006600">' + cerrados.length + '</div>' +
    '<div style="font-size:10px;color:#006600;font-weight:bold;letter-spacing:1px;margin-top:4px">CERRADOS</div>' +
    '</td>' +
    '</tr></table>' +
    '</td></tr>' +
    ...
    // ─ BY AREA ─
    '<tr><td style="padding:24px 32px 0">' +
    '<div style="font-size:12px;font-weight:bold;color:#0F6E56;text-transform:uppercase;letter-spacing:1px;border-left:4px solid #0F6E56;padding-left:10px;margin-bottom:12px">Por &Aacute;rea / Disciplina</div>' +
    '<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #e0e0e0;border-radius:6px;border-collapse:collapse">' +
    '<tr style="background-color:#0F6E56">' +
    '<td style="padding:10px 12px;font-size:11px;font-weight:bold;color:#ffffff;letter-spacing:1px;width:35%">&Aacute;REA</td>' +
    '<td style="padding:10px 12px;font-size:11px;font-weight:bold;color:#ffffff;letter-spacing:1px;text-align:center;width:20%">ABIERTOS</td>' +
    '<td style="padding:10px 12px;font-size:11px;font-weight:bold;color:#ffffff;letter-spacing:1px;text-align:center;width:20%">CERRADOS</td>' +
    '<td style="padding:10px 12px;font-size:11px;font-weight:bold;color:#ffffff;letter-spacing:1px;text-align:center;width:12%">TOTAL</td>' +
    '<td style="padding:10px 12px;font-size:11px;font-weight:bold;color:#ffffff;letter-spacing:1px;text-align:center;width:13%">% CIERRE</td>' +
    '</tr>' +
    areaRows +
    '</table>' +
    '</td></tr>' +
    ...
    '<div style="font-size:12px;font-weight:bold;color:#CC0000;text-transform:uppercase;letter-spacing:1px;border-left:4px solid #CC0000;padding-left:10px;margin-bottom:12px">Items Abiertos (' + abiertos.length + ')</div>' +
    '<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #e0e0e0;border-radius:6px;border-collapse:collapse">' +
    '<tr style="background-color:#7F1D1D">' +
    '<td style="padding:8px 10px;font-size:10px;font-weight:bold;color:#ffffff;letter-spacing:1px;width:65px">ID</td>' +
    '<td style="padding:8px 10px;font-size:10px;font-weight:bold;color:#ffffff;letter-spacing:1px;width:80px">FECHA</td>' +
    '<td style="padding:8px 10px;font-size:10px;font-weight:bold;color:#ffffff;letter-spacing:1px;width:80px">&Aacute;REA</td>' +
    '<td style="padding:8px 10px;font-size:10px;font-weight:bold;color:#ffffff;letter-spacing:1px">DESCRIPCI&Oacute;N</td>' +
    '<td style="padding:8px 10px;font-size:10px;font-weight:bold;color:#ffffff;letter-spacing:1px;width:90px">INSPECTOR</td>' +
    '</tr>' +
    itemRows +
    '</table>' +
    '</td></tr>' +
    ...
    '<a href="https://docs.google.com/spreadsheets/d/' + CONFIG.SHEET_ID + '" style="background-color:#0F6E56;color:#ffffff;text-decoration:none;padding:13px 36px;border-radius:6px;font-size:14px;font-weight:bold;display:inline-block">Ver Reporte Completo &rarr;</a>' +
    '</td></tr>' +

    // ─ FOOTER ─
    '<tr><td style="background-color:#f8f8f8;border-top:1px solid #e0e0e0;border-radius:0 0 8px 8px;padding:16px 32px;text-align:center">' +
    '<div style="font-size:11px;color:#999999">Punch List GSF1 CCPP &nbsp;&bull;&nbsp; TSK &nbsp;&bull;&nbsp; Generado autom&aacute;ticamente cada viernes</div>' +
    '<div style="font-size:11px;color:#999999;margin-top:6px">' +
    '<a href="https://gsfpunchlist.github.io/punch-list-gsf1/" style="color:#0F6E56;text-decoration:none">Abrir App</a>' +
    ' &nbsp;&bull;&nbsp; ' +
    '<a href="https://docs.google.com/spreadsheets/d/' + CONFIG.SHEET_ID + '" style="color:#0F6E56;text-decoration:none">Ver Sheet</a>' +
    '</div>' +
    '</td></tr>' +
